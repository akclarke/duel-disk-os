...
import { emit_attack_start } from '../../Client/Sender'
...
export default function(state = initialState, action) {
    ...
    if (action.type == START_BATTLE_DIRECT_ATTACK || action.type == START_BATTLE_OTHERS_ATTACK) {
        ...
        const battle_meta = {
            ...
            // Use side from payload if provided (CPU attacks pass SIDE.OPPONENT)
            side: info.side || SIDE.MINE
        }
        // Only emit in online mode — server not available offline
